...
Theo dõi qua [legal-changelog.md](./legal-changelog.md). Khi có văn bản mới: cập nhật bảng mục 1, domain docs, ruleset JSON, test case.

**Nguồn chấp nhận**: PDF công báo, vanban.chinhphu.vn, congbao.chinhphu.vn. Bản gốc lưu tại `docs/legal-originals/` (chỉ đọc tham chiếu).
