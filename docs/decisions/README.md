...
Mỗi quyết định nghiệp vụ lớn = 1 file. Đặt tên: `NNNN-tieu-de-ngan.md`.

| # | File | Quyết định | Status |
|---|------|------------|--------|
| 0001 | [0001-ruleset-versioning.md](./0001-ruleset-versioning.md) | Ruleset tham số luật theo `effective_from`/`effective_to` | Accepted |
