...
const vi: Dict = {
  ...
  'common.sources': 'Nguồn tham chiếu',
  'common.info': 'Thông tin',
  'settings.title': 'Cài đặt',
  'settings.subtitle': 'Vùng LTTV, ngôn ngữ và năm thuế — lưu cục bộ trên thiết bị.',
  'settings.about': 'Về chúng tôi',
  'settings.region': 'Vùng LTTV mặc định',
  'settings.regionHint': 'Áp dụng khi mở công cụ tính lương.',
  'settings.taxYear': 'Năm thuế mặc định',
  'settings.language': 'Ngôn ngữ',
  'settings.languageHint': 'Mặc định Tiếng Việt. Giao diện và chú thích info theo ngôn ngữ đã chọn.',
  'settings.ruleset': 'Cập nhật ruleset (F019)',
  'settings.rulesetHint':
    'Tải tham số luật công khai qua HTTPS — không gửi lương/thuế. Offline vẫn dùng bản kèm app.',
  'settings.checkRuleset': 'Kiểm tra cập nhật ruleset',
  'settings.checkingRuleset': 'Đang kiểm tra…',
  'settings.clearRulesetCache': 'Xóa cache ruleset từ xa',
  'settings.privacy': 'Quyền riêng tư & giới thiệu',
  'settings.showPrivacy': 'Xem tuyên bố',
  'settings.hidePrivacy': 'Thu gọn',
  'settings.privacyBody':
    'Tính toán, kịch bản và cài đặt được lưu cục bộ trên thiết bị. Không yêu cầu CCCD, MST hay số sổ BHXH. Không gửi dữ liệu lương/thuế lên máy chủ. Cập nhật ruleset chỉ tải file tham số luật công khai.',
  'settings.disclaimer': 'Disclaimer',
  'settings.disclaimerBody':
    'KVSalaryTools chỉ hỗ trợ ước tính. Kết quả không thay thế tư vấn pháp lý, kế toán hay quyết định của cơ quan thuế / BHXH.',
  'settings.reset': 'Đặt lại',
  'settings.resetDefaults': 'Đặt lại về mặc định',
  'settings.replayOnboarding': 'Xem lại hướng dẫn với Ngài Miu',
  'settings.feedback': 'Đóng góp ý kiến',
  'settings.feedbackHint':
    'Góp ý tính năng, báo lỗi hoặc chia sẻ trải nghiệm. Email mở ứng dụng thư trên máy bạn.',
  ...
  'settings.rulesetMeta': 'Đang có {count} ruleset · Lần kiểm tra: {when}',
  ...
  'other.totalTax': 'Tổng ước thuế',
  'other.vat': 'GTGT',
  'other.pit': 'TNCN',
  'about.role': 'Trợ lý hướng dẫn trong app',
  'about.body':
    'KVSalaryTools giúp ước tính lương Gross↔Net, quyết toán thuế và quyền lợi BHXH — offline, minh bạch từng khoản trừ. Ngài Miu chỉ đường; kết quả không thay thế tư vấn pháp lý.',
  ...
  'onboarding.start': 'Bắt đầu cùng Ngài Miu',
  'onboarding.privacy':
    'Tính toán lưu cục bộ trên thiết bị. Không yêu cầu CCCD / MST / sổ BHXH.',
  'onboarding.s1.title': 'Xin chào, tôi là Ngài Miu',
  'onboarding.s1.body':
    'Trợ lý của bạn trong KVSalaryTools — tôi sẽ chỉ đường qua từng bước tính lương, thuế và quyền lợi BHXH.',
  'onboarding.s2.title': 'Tính Gross ↔ Net',
  'onboarding.s2.body':
    'Ước tính lương offline theo ruleset 2025/2026. Breakdown từng khoản trừ — không che số.',
  'onboarding.s3.title': 'Quyết toán thuế năm',
  'onboarding.s3.body':
    'Đối chiếu đã khấu trừ với nghĩa vụ ước tính. Có wizard gợi ý ủy quyền hay tự QT.',
  'onboarding.s4.title': 'Quyền lợi BHXH',
  'onboarding.s4.body':
    'Thai sản, ốm đau, thôi việc, thất nghiệp, hưu / một lần — mỗi máy tính độc lập.',
  'calc.title': 'Tính lương',
  'calc.subtitle': 'Gross ↔ Net offline · thưởng Tết · OT · biểu thuế 2025 / 2026',
  'calc.withheldWarn':
    'Bạn chưa nhập thuế đã khấu trừ (đang dùng 0) — kết quả có thể lệch.',
  'settlement.title': 'Quyết toán',
  'settlement.subtitle':
    'Ước tính quyết toán thuế năm — đối chiếu với bảng lương trước khi nộp.',
  'settlement.cta': 'Ước quyết toán',
  'settlement.withheldWarn':
    'Bạn chưa nhập thuế đã khấu trừ (đang dùng 0) — kết quả có thể lệch.',
  'annual.heading': 'Breakdown năm',
  'annual.afterInsurance': 'TN sau BH (năm)',
  'annual.casual': 'Trong đó vãng lai',
  'annual.personalRelief': 'GTGC bản thân ×12',
  'annual.dependentRelief': 'GTGC NPT ×12',
  'annual.reliefTotal': 'Tổng GTGC năm',
  'annual.taxable': 'TNTT năm',
...
const en: Dict = {
  ...
  'settings.subtitle': 'Region, language and default tax year — stored on device.',
  ...
  'settings.languageHint': 'Default is Vietnamese. UI and info tips follow the selected language.',
  'settings.ruleset': 'Update ruleset (F019)',
  'settings.rulesetHint':
    'Downloads public law parameters over HTTPS — never sends salary data. Offline uses the bundled set.',
  ...
  'calc.subtitle': 'Gross ↔ Net offline · Tet bonus · OT · 2025 / 2026 tax schedules',
  'calc.withheldWarn':
...
export const MESSAGES: Record<LocaleCode, Dict> = { vi, en, zh, hi, es, fr, ja };
...
export function translate(
  ...
  const raw = MESSAGES[locale][key] ?? MESSAGES.vi[key] ?? MESSAGES.en[key] ?? key;
  if (!vars) return raw;
