...
export function SickLeaveInputs({ value, onChange }: Props) {
  ...
  return (
    <View style={styles.wrap}>
      ...
      <Section title="Số ngày nghỉ" subtitle="V1: ngày làm việc trong hạn trần năm.">
        <TextInput
      ...
      <Section title="Năm đóng BHXH" subtitle="Chọn trần 30/40/60 (hoặc 40/50/70 nếu nặng nhọc).">
        <TextInput
      ...
      <Section title="Điều kiện làm việc" subtitle="Nặng nhọc / độc hại / vùng đặc biệt khó khăn.">
