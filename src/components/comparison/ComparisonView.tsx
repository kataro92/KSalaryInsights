  ...
  return (
    <View style={styles.wrap} accessibilityLabel="So sánh thuế 2025 và 2026">
      ...
      <Text
        ...
        accessibilityLabel={`Chênh thuế ${formatVndSigned(result.delta.tax)}`}
      >
        Thuế: {formatVndSigned(result.delta.tax)}
        {taxSaved > 0
          ? ` (tiết kiệm ${taxSaved.toLocaleString("vi-VN")} ₫)`
          : ""}
      </Text>

      <View style={styles.yearBlock}>
        <Text
          style={[styles.yearLabel, styles.year2025]}
      ...
      <View style={styles.yearBlock}>
        <Text
          style={[styles.yearLabel, styles.year2026]}
          accessibilityRole="header"
        >
