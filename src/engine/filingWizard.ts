...
export function evaluateFilingWizard(
  ...
  return {
    conclusion,
    checklist,
    orgDeadlineLabel: `31/03/${settlementYear + 1} (tổ chức/ủy quyền — hướng dẫn từng năm)`,
    individualDeadlineLabel: `Đầu tháng 5/${settlementYear + 1} (cá nhân tự quyết toán — theo hướng dẫn năm)`,
    notes: [
